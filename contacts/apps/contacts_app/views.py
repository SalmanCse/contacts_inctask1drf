...
def index(request):
    contactss = Contacts.objects.all()
...
def edit(request, id):
    ...
    return render(request, 'contacts_app/edit.html', context)

def update(request, id):
    contacts = Contacts.objects.get(id=id)
    contacts.name = request.POST['name']
    contacts.breed = request.POST['breed']
    contacts.save()
    return redirect('/')
...
def destroy(request, id):
    #contacts = Contacts.objects.get(id=id)
    #Contacts.objects.delete(id=id)
    #contacts.name = request.POST['name']
    #contacts.breed = request.POST['breed']
    contacts = Contacts.objects.get(id=id)
    context = {"contacts":contacts}
    return render(request, 'contacts_app/delete.html', context)
    #contacts.delete()
    #return redirect('/')
